...
</dyad-file><dyad-problem-report summary="2 problems">
...
</dyad-problem-report> Os erros `TS2307: Cannot find module '@/types/dashboard'` e `TS2307: Cannot find module '@/lib/documentTemplates'` indicam que o compilador TypeScript não está conseguindo resolver os caminhos de importação que usam `@/`.
